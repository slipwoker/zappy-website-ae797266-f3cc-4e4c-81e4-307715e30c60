document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.hasAttribute('minlength') && field.tagName !== 'TEXTAREA') {
        const min = parseInt(field.getAttribute('minlength'), 10);
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            showFormMessage(contactForm, contactForm.dataset.successMessage || 'Thank you! Your message has been sent.', 'success');
            contactForm.reset();
            validatableFields.forEach(function (field) {
        ...
        .catch(function (err) {
          showFormMessage(contactForm, contactForm.dataset.errorMessage || 'Something went wrong. Please try again.', 'error');
        })
        .finally(function () {
          if (submitBtn) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עדי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ae797266-f3cc-4e4c-81e4-307715e30c60',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ae797266-f3cc-4e4c-81e4-307715e30c60';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ae797266-f3cc-4e4c-81e4-307715e30c60';
